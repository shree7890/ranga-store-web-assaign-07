...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h6><span class ="text">${product.rating.rate} Ratings</span> | <span class = "text-success">Counts: ${product.rating.count}</span> </h6>
      <p class= "danger fst-italic">Category: ${product.category}</p>
      <h3><span class = "price">Price:</span> <span class = "span">$ ${product.price}</span></h3>
